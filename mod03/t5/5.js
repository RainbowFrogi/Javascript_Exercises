...
for (let picture of picArray) {
  ...
  h2Element.innerHTML = picture.title;
  ...
  figcaptionElement.innerHTML = picture.caption;

  let pElement = document.createElement('p');
  pElement.innerHTML = picture.description;
  ...
  console.log('picture.medium is ' + picture.large);
}*/

// I REALISED THERE'S A BETTER WAY TO DO THIS
...
for (let picture of picArray) {
  ...
  articleElement.innerHTML = `
    <h2>${picture.title}</h2>
    <figure>
      <img src="${picture.image.medium}" alt="${picture.title}">
